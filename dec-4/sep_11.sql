...
CREATE TABLE Guitar1 (
    id int not null,brand VARCHAR(50),model VARCHAR(50),type VARCHAR(50),color VARCHAR(50),year INT
);


INSERT INTO Guitar1 VALUES
(1,'Fender', 'Stratocaster', 'Electric', 'Sunburst', 2020),
(2,'Gibson', 'Les Paul', 'Electric', 'Cherry Burst', 2019),
(3,'Taylor', '814ce', 'Acoustic', 'Natural', 2021),
(4,'Martin', 'D-28', 'Acoustic', 'Vintage Sunburst', 2018),
(5,'PRS', 'Custom 24', 'Electric', 'Black Gold Burst', 2022),
(6,'Ibanez', 'RG550', 'Electric', 'Desert Sun Yellow', 2020),
(7,'Epiphone', 'Hummingbird PRO', 'Acoustic', 'Faded Cherry Burst', 2019),
(8,'Gretsch', 'Streamliner', 'Electric', 'Golddust', 2021),
(9,'Yamaha', 'FG800', 'Acoustic', 'Natural', 2022),
(10,'ESP', 'LTD MH-1000', 'Electric', 'See Thru Black', 2017);
...
(1,'Samsung', 'Smart TV 1000', 55, 799),
(2,'LG', 'Ultra HD 2000', 65, 1299),
(3,'Sony', 'Bravia 3000', 60, 1499),
(4,'Toshiba', 'LED Plus 4000', 50, 699),
(5,'Panasonic', 'Viera 5000', 42, 599),
(6,'Sharp', 'Aquos 6000', 48, 799),
(7,'Hisense', 'Vision 7000', 55, 899),
(8,'Vizio', 'M-Series 8000', 70, 1799),
(9,'Philips', 'Ambilight 9000', 58, 999),
(10,'TCL', 'Roku TV 10000', 65, 1099);
...
select count(*) from tv where brand='Sharp';



select model,count(*) from tv group by model having model<1;
